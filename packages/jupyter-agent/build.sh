...
echo "=== Jupyter Agent Build Script ==="
echo ""
...
echo "   poetry add $(pwd)/dist/jupyter_agent-0.1.0-py3-none-any.whl"
echo ""
echo "   Or:"
echo "   poetry run pip install $(pwd)/dist/jupyter_agent-0.1.0-py3-none-any.whl"
