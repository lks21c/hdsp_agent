...
`, "",{"version":3,"sources":["webpack://./frontend/styles/index.css"],"names":[],"mappings":"AAAA;;;EAGE;;AAOF,qBAAqB;AACrB;EACE,0BAA0B;EAC1B,0BAA0B;EAC1B,2BAA2B;EAC3B,6BAA6B;EAC7B,oCAAoC;AACtC;;AAEA,mBAAmB;AACnB;EACE,YAAY;EACZ,aAAa;EACb,sBAAsB;AACxB","sourcesContent":["/**\n * Main Stylesheet for Jupyter Agent Extension\n * Imports all component styles\n */\n\n@import './cell-buttons.css';\n@import './agent-panel.css';\n@import './settings-panel.css';\n@import './launcher-icon.css';\n\n/* Global Variables */\n:root {\n  --jp-agent-spacing-sm: 4px;\n  --jp-agent-spacing-md: 8px;\n  --jp-agent-spacing-lg: 16px;\n  --jp-agent-border-radius: 4px;\n  --jp-agent-transition: all 0.2s ease;\n}\n\n/* Extension Root */\n.jp-agent-root {\n  height: 100%;\n  display: flex;\n  flex-direction: column;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
