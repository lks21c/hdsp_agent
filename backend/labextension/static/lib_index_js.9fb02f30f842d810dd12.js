...
/* harmony import */ var _utils_markdownRenderer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/markdownRenderer */ "./lib/utils/markdownRenderer.js");
/**
 ...
 */
const ChatPanel = (0,react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(({ apiService }, ref) => {
...
class AgentPanelWidget extends _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_1__.ReactWidget {
    ...
    render() {
        return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(ChatPanel, { ref: this.chatPanelRef, apiService: this.apiService });
    }
    /**
...
const TaskProgressWidget = ({ taskStatus, onClose, onCancel, onOpenNotebook }) => {
    ...
    const getStatusIcon = () => {
        if (isComplete)
            return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_icons_material_CheckCircle__WEBPACK_IMPORTED_MODULE_5__["default"], { fontSize: "small" });
        if (isFailed)
            return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_icons_material_Error__WEBPACK_IMPORTED_MODULE_6__["default"], { fontSize: "small" });
        if (isCancelled)
            return react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_icons_material_Cancel__WEBPACK_IMPORTED_MODULE_7__["default"], { fontSize: "small" });
        return null;
    };
    // Get status text
    const getStatusText = () => {
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.CardContent, { sx: { padding: 2, '&:last-child': { paddingBottom: 2 } } },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Box, { display: "flex", justifyContent: "space-between", alignItems: "center", mb: 1 },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Box, { display: "flex", alignItems: "center", gap: 1 },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Chip, { label: getStatusText(), size: "small", color: getStatusColor(), icon: getStatusIcon() || undefined })),
...
/* harmony import */ var _services_ApiService__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/ApiService */ "./lib/services/ApiService.js");
/**
 * Sidebar Plugin
...
const sidebarPlugin = {
    ...
    activate: (app, restorer, palette) => {
        console.log('[SidebarPlugin] Activating Jupyter Agent Sidebar');
        try {
            // Create API service
            const apiService = new _services_ApiService__WEBPACK_IMPORTED_MODULE_3__.ApiService();
            // Create agent panel widget
            const agentPanel = new _components_AgentPanel__WEBPACK_IMPORTED_MODULE_2__.AgentPanelWidget(apiService);
